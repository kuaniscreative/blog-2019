...
$(openNavBtn).click(function (e) {
  window.shouldPreventWheel = false; // index

  if ($("#indexSelection") !== undefined) {
    $("#indexSelection").removeClass("ani_innerFlyCard--left").addClass("ani_innerFlyCard--left").one("animationend", function (e) {
      e.stopPropagation();
      ...
      navContentToggle();
      $(".ani_outerFlyCard--bottom").eq(0).one("animationend", function () {
        $("#indexSelection").css("opacity", 1);
        $("#indexSelection").toggleClass("ani_innerFlyCard--left");
        $("body").toggleClass("ani_outerFlyCard--bottom");
        $(".navContentShow").each(function (i, val) {
          $(val).one("animationend", function (e) {
            e.stopPropagation();
  ...
  if ($("#article") !== undefined) {
    $(".articles_title").eq(0).removeClass("ani_innerFlyCard--left").addClass("ani_innerFlyCard--left");
    $(".articles_content").eq(0).removeClass("ani_innerFlyCard--left").addClass("ani_innerFlyCard--left").one("animationend", function (e) {
      e.stopPropagation();
      $(".articles_title").eq(0).css("opacity", 0);
      $(".articles_content").eq(0).css("opacity", 0);
      $("body").removeClass("ani_outerFlyCard--bottom").addClass("ani_outerFlyCard--bottom");
      $(nav).css({
        display: "block"
      });
      navContentToggle();
      $(".ani_outerFlyCard--bottom").eq(0).one("animationend", function () {
        $(".articles_title").eq(0).css("opacity", 1);
        $(".articles_content").eq(0).css("opacity", 1);
        $(".articles_title").eq(0).toggleClass("ani_innerFlyCard--left");
        $(".articles_content").eq(0).toggleClass("ani_innerFlyCard--left");
        $("body").toggleClass("ani_outerFlyCard--bottom");
        $(".navContentShow").each(function (i, val) {
          $(val).one("animationend", function (e) {
            e.stopPropagation();
...
$(function () {
  window.shouldPreventWheel = true; // scroll loop variables
