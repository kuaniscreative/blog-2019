...
/*!***************************************!*\
  !*** ./src/js/components/articles.js ***!
  \***************************************/
/*! exports provided: toggleArticleArea, articleAnimationShow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggleArticleArea", function() { return toggleArticleArea; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "articleAnimationShow", function() { return articleAnimationShow; });
var clickArea = $(".articles_titleClickArea")[0];
var black = "#202020";
var titleGray = "#f2f2f2";
var cubicBezier = "cubic-bezier(.14,.88,.86,1.01)"; // toggle article area

function toggleArticleArea() {
  var article = $('#article');
  $(article).toggle();
} // trigger article animation when show

function articleAnimationShow() {
...
articleAnimationShow(); // part of show animation
...
function addlistener_article() {
  var title = $(".articles_title span")[0];
  var content = $(".articles_content")[0];
  $(".articles_title span").eq(0).on("animationend", function (e) {
    e.stopPropagation();
  ...
  $(".articles_content").eq(0).on("animationend", function (e) {
    e.stopPropagation();
    var aniName = e.originalEvent.animationName;
...
console.log($("#indexSelection").css("display")); // nav animation
...
/* harmony import */ var _components_articles__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/articles */ "./src/js/components/articles.js");
...
var requestArticle = function requestArticle(param) {
  $.ajax({
    ...
    success: function success(res) {
      ...
      Object(_components_articles__WEBPACK_IMPORTED_MODULE_0__["articleAnimationShow"])();
    },
